...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { 
        path: 'minha-agenda',
        loadChildren: () => import('./pages/schedule/schedule.routes').then(m => m.routes),
        canActivate: [loggedUserGuard]
      },
      { 
        path: 'favoritos',
      ...
      { 
        path: 'ajuda',
        loadChildren: () => import('./pages/help/help.routes').then(m => m.routes),
      },
      { 
        path: 'meus-dados',
        loadChildren: () => import('./pages/user-data/user-data.routes').then(m => m.routes),
        canActivate: [loggedUserGuard]
      },
    ]
  },
